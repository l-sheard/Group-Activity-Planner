...
Click **Publish**. This lets any signed-in user (anonymous auth counts) read and write events. Because the house code acts as a shared password, only people you give the code to can find your data.
